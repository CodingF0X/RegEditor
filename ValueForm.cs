...
namespace RegEditor
{
    public partial class ValueForm : Form
    {
        ...
        public ValueForm()
        {
            ...
            this.Load += ValueForm_Load;
            this.FormClosing += ValueForm_FormClosing;
            this.toolTip1.SetToolTip(tbValue, "For Binary Format");
        ...
        private void ValueForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (this.DialogResult == System.Windows.Forms.DialogResult.OK)
            {
                if (this.tbName.Text.Trim().Length == 0)
                {
                    this.ep.SetError(this.tbName, "Enter Name");
                    e.Cancel = true;
                }
                else
                {
        ...
        private void tbValue_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                string currentString = this.tbValue.Text.Replace(" ", "").ToUpper();
